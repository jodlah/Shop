...
use ShopBundle\Form\PaymentType;
...
class PaymentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $payments = $em->getRepository('ShopBundle:Payment')->findAll();

        return $this->render('ShopBundle:payment:index.html.twig', array(
            'payments' => $payments,
        ));
    }
    ...
    {
        $payment = new Payment();
        $form = $this->createForm('ShopBundle\Form\PaymentType', $payment);
        ...
        return $this->render('ShopBundle:payment:new.html.twig', array(
            'payment' => $payment,
    ...
    public function showAction(Payment $payment)
    {
        ...
        return $this->render('ShopBundle:payment:show.html.twig', array(
            'payment' => $payment,
    ...
    {
        $deleteForm = $this->createDeleteForm($payment);
        $editForm = $this->createForm('ShopBundle\Form\PaymentType', $payment);
        ...
        return $this->render('ShopBundle:payment:edit.html.twig', array(
            'payment' => $payment,
